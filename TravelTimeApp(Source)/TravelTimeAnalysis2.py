...
try:
    import TravelTimeAnalysis as TTA  # the user's original pipeline
except Exception as e:
    raise RuntimeError(f"[TravelTimeAnalysis2] Failed to import TravelTimeAnalysis.py next to this file: {e}")
